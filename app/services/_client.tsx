...
const services = [
  {
    ...
    features: ["Custom ML models", "Process automation", "Predictive analytics"],
...
function GlowOrb({ cx, cy, color, size = 400 }: { cx: string; cy: string; color: string; size?: number }) {
  return (
    <div
      className="pointer-events-none absolute rounded-full blur-3xl"
      style={{ width: size, height: size, background: color, left: cx, top: cy, transform: "translate(-50%,-50%)", zIndex: 0 }}
    />
  );
}
...
function StatCard({ stat, index }: { stat: (typeof stats)[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: "linear-gradient(135deg,rgba(15,15,25,0.7) 0%,rgba(30,30,45,0.5) 100%)",
...
function ServiceCard({ service, index }: { service: (typeof services)[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      style={{
        background: "linear-gradient(135deg,rgba(12,12,22,0.85) 0%,rgba(25,25,40,0.7) 100%)",
    ...
    >
      ...
      {"tag" in service && service.tag && (
        <span className={`absolute top-5 right-5 text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full bg-gradient-to-r ${service.tagColor} text-black`}>
          {service.tag}
        </span>
      )}
      ...
      {/* Description */}
      <p className="text-zinc-400 text-sm leading-relaxed flex-1">{service.description}</p>
      ...
      <section id="services" className="relative py-24 px-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-zinc-400 text-lg max-w-2xl leading-relaxed">
              Six specialised service tracks, each engineered to solve a specific challenge and deliver measurable ROI.
            </motion.p>
          </motion.div>
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-zinc-400 text-lg max-w-xl leading-relaxed">
      ...
      <section className="relative py-24 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-zinc-400 text-lg max-w-xl leading-relaxed">
              We choose the right tools for each job — no over-engineering, no cutting corners.
            </motion.p>
          </motion.div>
            ...
            {technologies.map((tech, i) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(135deg,rgba(15,15,25,0.8) 0%,rgba(30,30,45,0.6) 100%)",
                    border: "1px solid rgba(255,255,255,0.07)",
      ...
      <section id="contact" className="relative py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            style={{
              background: "linear-gradient(135deg,rgba(6,182,212,0.1) 0%,rgba(59,130,246,0.08) 50%,rgba(139,92,246,0.1) 100%)",
          ...
          >
            ...
            <p className="text-zinc-400 text-lg max-w-xl leading-relaxed">
              Tell us about your project and we&apos;ll get back to you within 24 hours with a free consultation and cost estimate.
            </p>
